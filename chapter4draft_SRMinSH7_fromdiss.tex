...
Although not germane to the stability of Antarctic ice sheets, it is interesting to note the disparate temperature profiles north of 60$^\circ$S between Sulf and GHGrem as well. The warming evident equatorward of 60$^\circ$S at all depths in Sulf is a combination of residual warmth from pre-geoengineering, a poleward shift (fundamentally due to the atmospheric jet shift) of the nearly vertical isotherms there, and increased downwelling of warmer surface waters. This feature is noticeably absent when GHGs are instead removed from the atmosphere, as the jet rapidly returns to the 20thC position, and weak upwelling is found equatorward of 50$^\circ$S. These characteristics reinforce the importance of atmospheric wind changes on subsurface ocean temperatures.
...
\label{fig:pigtemp}
\end{figure*} % multiplied by specific heat of sea water, ocean density, and layer thickness;
