...
These results show that in the zonal mean, the large-scale oceanic environment remains conducive to basal melting of ice shelves even when stratospheric sulfate injections are implemented. We conclude by examining the ocean environment in the Pine Island Glacier (PIG) outlet region, a region that is particularly susceptible to marine instability \citep{favier14} and whose thinning has been accelerating rapidly \citep{rignot08}@@.
